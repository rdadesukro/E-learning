...
public class tes_up extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tes_up);
    ...
    public void RequestRunTimePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(tes_up.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

            Toast.makeText(tes_up.this, "READ_EXTERNAL_STORAGE permission Access Dialog", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(tes_up.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
        ...
        switch (RC) {
            ...
            case 1:
                ...
                if (Result.length > 0 && Result[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(tes_up.this, "Permission Granted", Toast.LENGTH_LONG).show();

                } else {

                    Toast.makeText(tes_up.this, "Permission Canceled", Toast.LENGTH_LONG).show();
