...
<form role = "form" action="<?php echo $aksi ?>" method="POST" enctype="multipart/form-data">
   <div class = "control-group">
		...
		<div class = "form-group">
			...
			<input type = "date" class = "form-control" required id = "tanggal" name="tanggal" value="<?php echo $result['tanggal']; ?>">
		</div>
		...
		<div class = "form-group">
			...
			<input type = "time" class = "form-control" required id = "jam" name="jam" value="<?php echo $result['jam']; ?>">
		</div>
